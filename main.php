...
<head>
  ...
  <style>
    ...
    @media (min-width: 992px) {
      ...
      /* Áp dụng cho màn hình lớn hơn 992px */
      .card {
        height: calc(400px + 2cm);
        /* Tăng chiều cao thẻ thêm 2cm */
      }
    }
            ...
            <div class="modal-content">
              ...
              <form action="add_task.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                  ...
                  <div class="mb-3 form-floating">
                    <textarea class="form-control" id="descInput" placeholder="" name="description"
      ...
      <ul class="nav-pills tabs-list" id="myTab" role="tablist">
        ...
        foreach ($categories as $category): ?>
          <li class="nav-item position-relative me-3" role="presentation">
            <a class="nav-link" data-bs-toggle="tab" href="#tab-<?php echo $i; ?>" role="tab"
              aria-controls="tab-<?php echo $i; ?>" aria-selected="false">
              <?php echo htmlspecialchars($category['category_name']); ?>
            </a>
            <!-- Nút xóa danh mục -->
            <form action="delete_category.php" method="POST" class="position-absolute top-0 start-100 translate-middle"
              id="deleteForm-<?php echo $category['category_id']; ?>">
              <input type="hidden" name="category_id" value="<?php echo $category['category_id']; ?>">
              <button type="button" class="btn btn-link p-0 text-danger" title="Xóa danh mục"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="#000"
                  stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x">
                  <path d="M18 6 6 18" />
                  <path d="m6 6 12 12" />
                </svg>
              </button>
